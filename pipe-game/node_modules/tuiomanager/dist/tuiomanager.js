...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! socket.io-client */ \"./node_modules/socket.io-client/lib/index.js\");\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _TUIOTouch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TUIOTouch */ \"./core/TUIOTouch.js\");\n/* harmony import */ var _TUIOTag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TUIOTag */ \"./core/TUIOTag.js\");\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants */ \"./core/constants.js\");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n/**\n * @author Christian Brel <ch.brel@gmail.com>\n * @author Vincent Forquet\n * @author Nicolas Forget\n */\n\n\n\n\n/**\n * Manage TUIOManager singleton class.\n *\n * @type TUIOManager\n * @private\n */\n\nvar tuioManagerInstance = null;\n/**\n * Main class to manage TUIOManager.\n *\n * @class TUIOManager\n */\n\nvar TUIOManager =\n/*#__PURE__*/\nfunction () {\n  /**\n   * TUIOManager constructor.\n   *\n   * @constructor\n   */\n  function TUIOManager() {\n    _classCallCheck(this, TUIOManager);\n\n    if (tuioManagerInstance !== null) {\n      return tuioManagerInstance;\n    }\n\n    this._touches = {};\n    this._tags = {};\n    this._widgets = {};\n    tuioManagerInstance = this;\n    return tuioManagerInstance;\n  }\n  /**\n   * Init and start TUIOManager.\n   *\n   * @method getInstance\n   * @static\n   * @returns {TUIOManager} The TUIOManager instance.\n   */\n\n\n  _createClass(TUIOManager, [{\n    key: \"addWidget\",\n\n    /**\n     * Add a TUIOWidget as observer of TUIOManager.\n     *\n     * @method addWidget\n     * @param {TUIOWidget} widget - TUIOWidget instance to add as observer of TUIOManager.\n     */\n    value: function addWidget(widget) {\n      if (typeof this._widgets[widget.id] === 'undefined') {\n        this._widgets = _objectSpread({}, this._widgets, _defineProperty({}, widget.id, widget));\n      }\n    }\n    /**\n     * Remove TUIOWidget in param from TUIOManager's observers.\n     *\n     * @method removeWidget\n     * @param {TUIOWidget} widget - TUIOWidget instance to remove from TUIOManager's observers.\n     */\n\n  }, {\n    key: \"removeWidget\",\n    value: function removeWidget(widget) {\n      if (typeof this._widgets[widget.id] !== 'undefined') {\n        delete this._widgets[widget.id];\n      }\n    }\n    /**\n     * Notify all widgets/observers.\n     *\n     * @method notifyWidgets\n     * @param {string} methodToCall - TUIOWidget method name to call.\n     * @param {any} param - Param for method call.\n     */\n\n  }, {\n    key: \"notifyWidgets\",\n    value: function notifyWidgets(methodToCall, param) {\n      var _this = this;\n\n      Object.keys(this._widgets).forEach(function (widgetId) {\n        var currentWidget = _this._widgets[widgetId];\n        currentWidget[methodToCall](param);\n      });\n    }\n    /**\n     * Init and start TUIOManager.\n     *\n     * @method start\n     * @param {string} socketIOUrl - Socket IO Server's url. Default : 'http://localhost:9000/'\n     */\n\n  }, {\n    key: \"start\",\n    value: function start() {\n      var _this2 = this;\n\n      var socketIOUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'http://localhost:9000/';\n      var socketIOClient = socket_io_client__WEBPACK_IMPORTED_MODULE_0___default()(socketIOUrl);\n      socketIOClient.on(_constants__WEBPACK_IMPORTED_MODULE_3__[\"CREATE_SOCKETIO_ACTION\"], function (data) {\n        _this2.handleCreate(data);\n      });\n      socketIOClient.on(_constants__WEBPACK_IMPORTED_MODULE_3__[\"UPDATE_SOCKETIO_ACTION\"], function (data) {\n        _this2.handleUpdate(data);\n      });\n      socketIOClient.on(_constants__WEBPACK_IMPORTED_MODULE_3__[\"DELETE_SOCKETIO_ACTION\"], function (data) {\n        _this2.handleDelete(data);\n      });\n    }\n    /**\n     * Handle CREATE Action from socket.\n     *\n     * @method handleCreate\n     * @param {JSON} socketData - 'Create' data from TUIOClient.\n     */\n\n  }, {\n    key: \"handleCreate\",\n    value: function handleCreate(socketData) {\n      switch (socketData.type) {\n        case _constants__WEBPACK_IMPORTED_MODULE_3__[\"TOUCH_SOCKETIO_TYPE\"]:\n          {\n            this._touches[socketData.id] = new _TUIOTouch__WEBPACK_IMPORTED_MODULE_1__[\"default\"](socketData.id, socketData.x * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_WIDTH\"], socketData.y * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_HEIGHT\"]);\n            this.notifyWidgets('onTouchCreation', this._touches[socketData.id]);\n\n            this._touches[socketData.id].update(socketData.x * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_WIDTH\"], socketData.y * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_HEIGHT\"]);\n\n            break;\n          }\n\n        case _constants__WEBPACK_IMPORTED_MODULE_3__[\"TAG_SOCKETIO_TYPE\"]:\n          {\n            this._tags[socketData.id] = new _TUIOTag__WEBPACK_IMPORTED_MODULE_2__[\"default\"](socketData.id, socketData.x * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_WIDTH\"], socketData.y * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_HEIGHT\"], socketData.angle);\n            this.notifyWidgets('onTagCreation', this._tags[socketData.id]);\n\n            this._tags[socketData.id].update(socketData.x * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_WIDTH\"], socketData.y * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_HEIGHT\"], socketData.angle);\n\n            break;\n          }\n\n        default:\n          break;\n      }\n    }\n    /**\n     * Handle UPDATE Action from socket.\n     *\n     * @method handleUpdate\n     * @param {JSON} socketData - 'Update' data from TUIOClient.\n     */\n\n  }, {\n    key: \"handleUpdate\",\n    value: function handleUpdate(socketData) {\n      switch (socketData.type) {\n        case _constants__WEBPACK_IMPORTED_MODULE_3__[\"TOUCH_SOCKETIO_TYPE\"]:\n          {\n            if (typeof this._touches[socketData.id] !== 'undefined') {\n              this._touches[socketData.id].update(socketData.x * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_WIDTH\"], socketData.y * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_HEIGHT\"]);\n            }\n\n            break;\n          }\n\n        case _constants__WEBPACK_IMPORTED_MODULE_3__[\"TAG_SOCKETIO_TYPE\"]:\n          {\n            if (typeof this._tags[socketData.id] !== 'undefined') {\n              this._tags[socketData.id].update(socketData.x * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_WIDTH\"], socketData.y * _constants__WEBPACK_IMPORTED_MODULE_3__[\"WINDOW_HEIGHT\"], socketData.angle);\n            }\n\n            break;\n          }\n\n        default:\n          break;\n      }\n    }\n    /**\n     * Handle DELETE Action from socket.\n     *\n     * @method handleDelete\n     * @param {JSON} socketData - 'Delete' data from TUIOClient.\n     */\n\n  }, {\n    key: \"handleDelete\",\n    value: function handleDelete(socketData) {\n      switch (socketData.type) {\n        case _constants__WEBPACK_IMPORTED_MODULE_3__[\"TOUCH_SOCKETIO_TYPE\"]:\n          {\n            if (typeof this._touches[socketData.id] !== 'undefined') {\n              this.notifyWidgets('onTouchDeletion', socketData.id);\n              delete this._touches[socketData.id];\n            }\n\n            break;\n          }\n\n        case _constants__WEBPACK_IMPORTED_MODULE_3__[\"TAG_SOCKETIO_TYPE\"]:\n          {\n            if (typeof this._tags[socketData.id] !== 'undefined') {\n              this.notifyWidgets('onTagDeletion', socketData.id);\n              delete this._tags[socketData.id];\n            }\n\n            break;\n          }\n\n        default:\n          break;\n      }\n    }\n  }], [{\n    key: \"getInstance\",\n    value: function getInstance() {\n      return new TUIOManager();\n    }\n  }]);\n\n  return TUIOManager;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (TUIOManager);\n\n//# sourceURL=webpack:///./core/TUIOManager.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _TUIOObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TUIOObject */ \"./core/TUIOObject.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _get(target, property, receiver) { if (typeof Reflect !== \"undefined\" && Reflect.get) { _get = Reflect.get; } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return _get(target, property, receiver || target); }\n\nfunction _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf(object); if (object === null) break; } return object; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n/**\n * @author Christian Brel <ch.brel@gmail.com>\n * @author Vincent Forquet\n * @author Nicolas Forget\n */\n\n/**\n * Main class to manage TUIOTouch.\n *\n * @class TUIOTouch\n * @extends TUIOObject\n */\n\nvar TUIOTouch =\n/*#__PURE__*/\nfunction (_TUIOObject) {\n  _inherits(TUIOTouch, _TUIOObject);\n\n  function TUIOTouch() {\n    _classCallCheck(this, TUIOTouch);\n\n    return _possibleConstructorReturn(this, _getPrototypeOf(TUIOTouch).apply(this, arguments));\n  }\n\n  _createClass(TUIOTouch, [{\n    key: \"update\",\n\n    /**\n     * Update TUIOTouch.\n     *\n     * @method update\n     * @param {string/number} x - New TUIOTouch's abscissa.\n     * @param {string/number} y - New TUIOTouch's ordinate.\n     */\n    value: function update(x, y) {\n      _get(_getPrototypeOf(TUIOTouch.prototype), \"update\", this).call(this, x, y);\n\n      this.notifyWidgets('onTouchUpdate');\n    }\n  }]);\n\n  return TUIOTouch;\n}(_TUIOObject__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (TUIOTouch);\n\n//# sourceURL=webpack:///./core/TUIOTouch.js?");
...
/*!***************************!*\
  !*** ./core/constants.js ***!
  \***************************/
/*! exports provided: WINDOW_WIDTH, WINDOW_HEIGHT, CREATE_SOCKETIO_ACTION, UPDATE_SOCKETIO_ACTION, DELETE_SOCKETIO_ACTION, TOUCH_SOCKETIO_TYPE, TAG_SOCKETIO_TYPE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"WINDOW_WIDTH\", function() { return WINDOW_WIDTH; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"WINDOW_HEIGHT\", function() { return WINDOW_HEIGHT; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"CREATE_SOCKETIO_ACTION\", function() { return CREATE_SOCKETIO_ACTION; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"UPDATE_SOCKETIO_ACTION\", function() { return UPDATE_SOCKETIO_ACTION; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"DELETE_SOCKETIO_ACTION\", function() { return DELETE_SOCKETIO_ACTION; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"TOUCH_SOCKETIO_TYPE\", function() { return TOUCH_SOCKETIO_TYPE; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"TAG_SOCKETIO_TYPE\", function() { return TAG_SOCKETIO_TYPE; });\n/* Window Dimension */\nvar WINDOW_WIDTH = 1920;\nvar WINDOW_HEIGHT = 1080;\n/* SOCKET.IO message Actions */\n\nvar CREATE_SOCKETIO_ACTION = 'CREATE';\nvar UPDATE_SOCKETIO_ACTION = 'UPDATE';\nvar DELETE_SOCKETIO_ACTION = 'DELETE';\n/* SOCKET.IO message Types */\n\nvar TOUCH_SOCKETIO_TYPE = 'TOUCH';\nvar TAG_SOCKETIO_TYPE = 'TAG';\n\n//# sourceURL=webpack:///./core/constants.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _core_TUIOManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/TUIOManager */ \"./core/TUIOManager.js\");\n/**\n * @author Christian Brel <ch.brel@gmail.com>\n */\n// Import TUIOManager\n\nvar tuioManager = new _core_TUIOManager__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\ntuioManager.start();\n\n//# sourceURL=webpack:///./src/index.js?");
