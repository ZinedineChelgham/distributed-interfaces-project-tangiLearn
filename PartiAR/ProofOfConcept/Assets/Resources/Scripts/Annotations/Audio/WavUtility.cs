...
public static class WavUtility
{
    public static byte[] FromAudioClip(AudioClip clip)
    {
        ...
        {
            using (var waveFileWriter = new WaveFileWriter(memoryStream, format))
            {
                waveFileWriter.Write(bytesData, 0, bytesData.Length);
	...
	/// <summary>
	/// CODE PRIS DE : https://github.com/deadlyfingers/UnityWav car autrement gros pb de bruit quand on reconstruit le fichier
	/// </summary>
